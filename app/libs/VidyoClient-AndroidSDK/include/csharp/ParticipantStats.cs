...
namespace VidyoClient
{
	public class ParticipantStats{
		...
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr VidyoParticipantStatsGetUserDataNative(IntPtr obj);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		public static extern void VidyoParticipantStatsSetUserDataNative(IntPtr obj, IntPtr userData);
		...
		public ParticipantStats(IntPtr obj){
			...
			id = Marshal.PtrToStringAnsi(VidyoParticipantStatsGetidNative(objPtr));
			name = Marshal.PtrToStringAnsi(VidyoParticipantStatsGetnameNative(objPtr));
			...
			userId = Marshal.PtrToStringAnsi(VidyoParticipantStatsGetuserIdNative(objPtr));
