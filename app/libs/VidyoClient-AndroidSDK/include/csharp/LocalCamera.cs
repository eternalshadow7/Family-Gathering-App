...
namespace VidyoClient
{
	public class LocalCamera{
		...
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern void VidyoLocalCameraSetMaxBitRateNative(IntPtr c, uint bitRate);
		...
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoLocalCameraSetPreviewLabelNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String previewLabel);
		...
		public void SetMaxBitRate(uint bitRate){
			...
			VidyoLocalCameraSetMaxBitRateNative(objPtr, bitRate);
		}
		...
		public Boolean SetPreviewLabel(String previewLabel){
			...
			Boolean ret = VidyoLocalCameraSetPreviewLabelNative(objPtr, previewLabel);
