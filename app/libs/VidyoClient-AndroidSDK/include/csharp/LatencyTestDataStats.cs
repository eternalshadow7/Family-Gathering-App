...
namespace VidyoClient
{
	public class LatencyTestDataStats{
		...
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr VidyoLatencyTestDataStatsGetUserDataNative(IntPtr obj);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		public static extern void VidyoLatencyTestDataStatsSetUserDataNative(IntPtr obj, IntPtr userData);
		...
		public LatencyTestDataStats(IntPtr obj){
			...
			address = Marshal.PtrToStringAnsi(VidyoLatencyTestDataStatsGetaddressNative(objPtr));
			...
			name = Marshal.PtrToStringAnsi(VidyoLatencyTestDataStatsGetnameNative(objPtr));
