...
namespace VidyoClient
{
	public class Room{
		...
		private static extern Boolean VidyoRoomAcceptIncomingNative(IntPtr r, OnEntered onEntered, OnExited onExited);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomAcquireMediaRouteNative(IntPtr r, OnMediaRouteAcquired onMediaRouteAcquired);
		...
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomEnterNative(IntPtr r, OnEntered onEntered, OnExited onExited);
		...
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomInviteNative(IntPtr r, [MarshalAs(UnmanagedType.LPStr)]String userId, [MarshalAs(UnmanagedType.LPStr)]String message);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomInviteAllNative(IntPtr r, [MarshalAs(UnmanagedType.LPStr)]String message);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomInviteNNative(IntPtr r, IntPtr userIds, [MarshalAs(UnmanagedType.LPStr)]String message);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomLeaveNative(IntPtr r);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomMessageSearchNative(IntPtr r, [MarshalAs(UnmanagedType.LPStr)]String searchText, uint index, uint pageSize, OnMessageSearchResults onMessageSearchResults);
		...
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomSendMessageNative(IntPtr r, [MarshalAs(UnmanagedType.LPStr)]String message);
		...
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomSetSubjectNative(IntPtr r, [MarshalAs(UnmanagedType.LPStr)]String subject);
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void OnDynamicParticipantChanged(IntPtr room, IntPtr dynamicSelectedParticipants, IntPtr dynamicSelectedCameras);
		private static OnDynamicParticipantChanged _mOnDynamicParticipantChanged;
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern IntPtr VidyoRoomOnDynamicParticipantChangedGetdynamicSelectedParticipantsArrayNative(IntPtr obj, ref int size);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern IntPtr VidyoRoomOnDynamicParticipantChangedFreedynamicSelectedParticipantsArrayNative(IntPtr obj, int size);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern IntPtr VidyoRoomOnDynamicParticipantChangedGetdynamicSelectedCamerasArrayNative(IntPtr obj, ref int size);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern IntPtr VidyoRoomOnDynamicParticipantChangedFreedynamicSelectedCamerasArrayNative(IntPtr obj, int size);
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void OnLoudestParticipantChanged(IntPtr room, IntPtr participant, Boolean isAudioOnly);
		...
		public interface IGetHistoryById{

			void OnGetHistoryResults(List<ChatMessage> records, long historySize, RoomSearchResult result);
		}
		public interface IGetHistoryByTime{
		...
		public interface IRegisterParticipantEventListener{
			...
			void OnDynamicParticipantChanged(List<Participant> dynamicSelectedParticipants, List<RemoteCamera> dynamicSelectedCameras);
			void OnLoudestParticipantChanged(Participant participant, Boolean isAudioOnly);
		}
		...
		public class GenerationDiff{
			...
			[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
			public static extern IntPtr VidyoGenerationDiffGetUserDataNative(IntPtr obj);

			[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
			public static extern void VidyoGenerationDiffSetUserDataNative(IntPtr obj, IntPtr userData);
		...
		public class RoomProperties{
			...
			[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
			public static extern IntPtr VidyoRoomPropertiesGetUserDataNative(IntPtr obj);

			[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
			public static extern void VidyoRoomPropertiesSetUserDataNative(IntPtr obj, IntPtr userData);
			...
			public class RoomParticipantProfile{
				...
				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr VidyoRoomParticipantProfileGetUserDataNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				public static extern void VidyoRoomParticipantProfileSetUserDataNative(IntPtr obj, IntPtr userData);
				...
				public RoomParticipantProfile(IntPtr obj){
					...
					userId = Marshal.PtrToStringAnsi(VidyoRoomParticipantProfileGetuserIdNative(objPtr));
					windowShare = VidyoRoomParticipantProfileGetwindowShareNative(objPtr);
				}
			};
			public class RoomSchedule{
				private IntPtr objPtr; // opaque VidyoRoomSchedule reference.
				public IntPtr GetObjectPtr(){
					return objPtr;
				}
				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				private static extern IntPtr VidyoRoomScheduleGetbyDayNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				private static extern IntPtr VidyoRoomScheduleGetbyMonthNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				private static extern IntPtr VidyoRoomScheduleGetbyMonthDayNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				private static extern IntPtr VidyoRoomScheduleGetbySetPosNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				private static extern IntPtr VidyoRoomScheduleGetbyWeekNumNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				private static extern IntPtr VidyoRoomScheduleGetbyYearDayNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				private static extern IntPtr VidyoRoomScheduleGetcountNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				private static extern IntPtr VidyoRoomScheduleGetdurationNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				private static extern IntPtr VidyoRoomScheduleGetendTimeNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				private static extern IntPtr VidyoRoomScheduleGeteventIdNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				private static extern IntPtr VidyoRoomScheduleGetfrequencyNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				private static extern IntPtr VidyoRoomScheduleGetintervalNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				private static extern IntPtr VidyoRoomScheduleGetstartTimeNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				private static extern IntPtr VidyoRoomScheduleGetuntilNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				private static extern IntPtr VidyoRoomScheduleGetweekStartDayNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr VidyoRoomScheduleGetUserDataNative(IntPtr obj);

				[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
				public static extern void VidyoRoomScheduleSetUserDataNative(IntPtr obj, IntPtr userData);
				...
				public RoomSchedule(IntPtr obj){
					objPtr = obj;

					byDay = Marshal.PtrToStringAnsi(VidyoRoomScheduleGetbyDayNative(objPtr));
					byMonth = Marshal.PtrToStringAnsi(VidyoRoomScheduleGetbyMonthNative(objPtr));
					byMonthDay = Marshal.PtrToStringAnsi(VidyoRoomScheduleGetbyMonthDayNative(objPtr));
					bySetPos = Marshal.PtrToStringAnsi(VidyoRoomScheduleGetbySetPosNative(objPtr));
					byWeekNum = Marshal.PtrToStringAnsi(VidyoRoomScheduleGetbyWeekNumNative(objPtr));
					byYearDay = Marshal.PtrToStringAnsi(VidyoRoomScheduleGetbyYearDayNative(objPtr));
					count = Marshal.PtrToStringAnsi(VidyoRoomScheduleGetcountNative(objPtr));
					duration = Marshal.PtrToStringAnsi(VidyoRoomScheduleGetdurationNative(objPtr));
					endTime = Marshal.PtrToStringAnsi(VidyoRoomScheduleGetendTimeNative(objPtr));
					eventId = Marshal.PtrToStringAnsi(VidyoRoomScheduleGeteventIdNative(objPtr));
					frequency = Marshal.PtrToStringAnsi(VidyoRoomScheduleGetfrequencyNative(objPtr));
					interval = Marshal.PtrToStringAnsi(VidyoRoomScheduleGetintervalNative(objPtr));
					startTime = Marshal.PtrToStringAnsi(VidyoRoomScheduleGetstartTimeNative(objPtr));
					until = Marshal.PtrToStringAnsi(VidyoRoomScheduleGetuntilNative(objPtr));
					weekStartDay = Marshal.PtrToStringAnsi(VidyoRoomScheduleGetweekStartDayNative(objPtr));
				}
			};
			...
			public RoomProperties(IntPtr obj){
				...
				while (nAdministratorsIndex < nAdministratorsSize) {
					csAdministrators.Add(Marshal.PtrToStringAnsi(Marshal.ReadIntPtr(nAdministrators + (nAdministratorsIndex * Marshal.SizeOf(nAdministrators)))));
				...
				while (nMembersIndex < nMembersSize) {
					csMembers.Add(Marshal.PtrToStringAnsi(Marshal.ReadIntPtr(nMembers + (nMembersIndex * Marshal.SizeOf(nMembers)))));
					nMembersIndex++;
				}
				...
				while (nModeratorsIndex < nModeratorsSize) {
					csModerators.Add(Marshal.PtrToStringAnsi(Marshal.ReadIntPtr(nModerators + (nModeratorsIndex * Marshal.SizeOf(nModerators)))));
					nModeratorsIndex++;
				}
				...
				while (nOutcastsIndex < nOutcastsSize) {
					csOutcasts.Add(Marshal.PtrToStringAnsi(Marshal.ReadIntPtr(nOutcasts + (nOutcastsIndex * Marshal.SizeOf(nOutcasts)))));
					nOutcastsIndex++;
				}
				...
				while (nOwnersIndex < nOwnersSize) {
					csOwners.Add(Marshal.PtrToStringAnsi(Marshal.ReadIntPtr(nOwners + (nOwnersIndex * Marshal.SizeOf(nOwners)))));
					nOwnersIndex++;
				}
				...
				description = Marshal.PtrToStringAnsi(VidyoRoomPropertiesGetdescriptionNative(objPtr));
				...
				language = Marshal.PtrToStringAnsi(VidyoRoomPropertiesGetlanguageNative(objPtr));
				maxParticipants = VidyoRoomPropertiesGetmaxParticipantsNative(objPtr);
				members = csMembers;
				moderators = csModerators;
				name = Marshal.PtrToStringAnsi(VidyoRoomPropertiesGetnameNative(objPtr));
				outcasts = csOutcasts;
				owners = csOwners;
				participantProfiles = csParticipantProfiles;
				password = Marshal.PtrToStringAnsi(VidyoRoomPropertiesGetpasswordNative(objPtr));
		...
		private static IGetHistoryById _mIGetHistoryById;
		private static IGetHistoryByTime _mIGetHistoryByTime;
		...
		public Boolean AcceptIncoming(IAcceptIncoming _iIAcceptIncoming){
			...
			Boolean ret = VidyoRoomAcceptIncomingNative(objPtr, _mOnEntered, _mOnExited);
		...
		public Boolean AcquireMediaRoute(IAcquireMediaRoute _iIAcquireMediaRoute){
			...
			Boolean ret = VidyoRoomAcquireMediaRouteNative(objPtr, _mOnMediaRouteAcquired);
		...
		public Boolean Enter(IAcceptIncoming _iIAcceptIncoming){
			_mIAcceptIncoming = _iIAcceptIncoming;
			_mOnEntered = OnEnteredDelegate;
			_mOnExited = OnExitedDelegate;

			Boolean ret = VidyoRoomEnterNative(objPtr, _mOnEntered, _mOnExited);
		...
		public Boolean Invite(String userId, String message){

			Boolean ret = VidyoRoomInviteNative(objPtr, userId, message);

			return ret;
		}
		public Boolean InviteAll(String message){

			Boolean ret = VidyoRoomInviteAllNative(objPtr, message);

			return ret;
		}
		public Boolean InviteN(List<String> userIds, String message){

			IntPtr nUserIds = IntPtr.Zero;

			Boolean ret = VidyoRoomInviteNNative(objPtr, nUserIds, message);
		...
		public Boolean MessageSearch(String searchText, uint index, uint pageSize, IMessageSearch _iIMessageSearch){
			...
			Boolean ret = VidyoRoomMessageSearchNative(objPtr, searchText, index, pageSize, _mOnMessageSearchResults);
		...
		public Boolean SendMessage(String message){
			...
			Boolean ret = VidyoRoomSendMessageNative(objPtr, message);
		...
		public Boolean SetSubject(String subject){
			...
			Boolean ret = VidyoRoomSetSubjectNative(objPtr, subject);
...
#endif
		private static void OnDynamicParticipantChangedDelegate(IntPtr room, IntPtr dynamicSelectedParticipants, IntPtr dynamicSelectedCameras){
			List<Participant> csDynamicSelectedParticipants = new List<Participant>();
			int nDynamicSelectedParticipantsSize = 0;
			IntPtr nDynamicSelectedParticipants = VidyoRoomOnDynamicParticipantChangedGetdynamicSelectedParticipantsArrayNative(dynamicSelectedParticipants, ref nDynamicSelectedParticipantsSize);
			int nDynamicSelectedParticipantsIndex = 0;
			while (nDynamicSelectedParticipantsIndex < nDynamicSelectedParticipantsSize) {
				Participant csTdynamicSelectedParticipants = null;
				if(Marshal.ReadIntPtr(nDynamicSelectedParticipants + (nDynamicSelectedParticipantsIndex * Marshal.SizeOf(nDynamicSelectedParticipants))) != IntPtr.Zero){
					if(Participant.VidyoParticipantGetUserDataNative(Marshal.ReadIntPtr(nDynamicSelectedParticipants + (nDynamicSelectedParticipantsIndex * Marshal.SizeOf(nDynamicSelectedParticipants)))) == IntPtr.Zero)
						csTdynamicSelectedParticipants = new Participant(Marshal.ReadIntPtr(nDynamicSelectedParticipants + (nDynamicSelectedParticipantsIndex * Marshal.SizeOf(nDynamicSelectedParticipants))));
					else{
						GCHandle objHandle = (GCHandle)Participant.VidyoParticipantGetUserDataNative(Marshal.ReadIntPtr(nDynamicSelectedParticipants + (nDynamicSelectedParticipantsIndex * Marshal.SizeOf(nDynamicSelectedParticipants))));
						csTdynamicSelectedParticipants = (Participant)objHandle.Target;
					}
				}
				csDynamicSelectedParticipants.Add(csTdynamicSelectedParticipants);
				nDynamicSelectedParticipantsIndex++;
			}

			List<RemoteCamera> csDynamicSelectedCameras = new List<RemoteCamera>();
			int nDynamicSelectedCamerasSize = 0;
			IntPtr nDynamicSelectedCameras = VidyoRoomOnDynamicParticipantChangedGetdynamicSelectedCamerasArrayNative(dynamicSelectedCameras, ref nDynamicSelectedCamerasSize);
			int nDynamicSelectedCamerasIndex = 0;
			while (nDynamicSelectedCamerasIndex < nDynamicSelectedCamerasSize) {
				RemoteCamera csTdynamicSelectedCameras = null;
				if(Marshal.ReadIntPtr(nDynamicSelectedCameras + (nDynamicSelectedCamerasIndex * Marshal.SizeOf(nDynamicSelectedCameras))) != IntPtr.Zero){
					if(RemoteCamera.VidyoRemoteCameraGetUserDataNative(Marshal.ReadIntPtr(nDynamicSelectedCameras + (nDynamicSelectedCamerasIndex * Marshal.SizeOf(nDynamicSelectedCameras)))) == IntPtr.Zero)
						csTdynamicSelectedCameras = new RemoteCamera(Marshal.ReadIntPtr(nDynamicSelectedCameras + (nDynamicSelectedCamerasIndex * Marshal.SizeOf(nDynamicSelectedCameras))));
					else{
						GCHandle objHandle = (GCHandle)RemoteCamera.VidyoRemoteCameraGetUserDataNative(Marshal.ReadIntPtr(nDynamicSelectedCameras + (nDynamicSelectedCamerasIndex * Marshal.SizeOf(nDynamicSelectedCameras))));
						csTdynamicSelectedCameras = (RemoteCamera)objHandle.Target;
					}
				}
				csDynamicSelectedCameras.Add(csTdynamicSelectedCameras);
				nDynamicSelectedCamerasIndex++;
			}

			if(_mIRegisterParticipantEventListener != null)
				_mIRegisterParticipantEventListener.OnDynamicParticipantChanged(csDynamicSelectedParticipants, csDynamicSelectedCameras);
			VidyoRoomOnDynamicParticipantChangedFreedynamicSelectedCamerasArrayNative(nDynamicSelectedCameras, nDynamicSelectedCamerasSize);
			VidyoRoomOnDynamicParticipantChangedFreedynamicSelectedParticipantsArrayNative(nDynamicSelectedParticipants, nDynamicSelectedParticipantsSize);
		}
#if __IOS__
[ObjCRuntime.MonoPInvokeCallback(typeof(OnEntered))]
		...
		private static void OnEnteredDelegate(IntPtr room, RoomEnterResult result){
			if(_mIAcceptIncoming != null)
				_mIAcceptIncoming.OnEntered(result);
		}
#if __IOS__
[ObjCRuntime.MonoPInvokeCallback(typeof(OnExited))]
		...
		private static void OnExitedDelegate(IntPtr room, RoomExitReason reason){
			if(_mIAcceptIncoming != null)
				_mIAcceptIncoming.OnExited(reason);
		}
#if __IOS__
...
#endif
		private static void OnLoudestParticipantChangedDelegate(IntPtr room, IntPtr participant, Boolean isAudioOnly){
			...
			if(_mIRegisterParticipantEventListener != null)
				_mIRegisterParticipantEventListener.OnLoudestParticipantChanged(csParticipant, isAudioOnly);
		}
#if __IOS__
...
[ObjCRuntime.MonoPInvokeCallback(typeof(OnMessageSearchResults))]
		...
		private static void OnMessageSearchResultsDelegate(IntPtr room, IntPtr searchText, IntPtr records, RoomSearchResult result){
			...
			if(_mIMessageSearch != null)
				_mIMessageSearch.OnMessageSearchResults(Marshal.PtrToStringAnsi(searchText), csRecords, result);
...
[ObjCRuntime.MonoPInvokeCallback(typeof(OnSetSubject))]
		...
		private static void OnSetSubjectDelegate(IntPtr room, IntPtr subject){
			if(_mIRegisterSubjectEventListener != null)
				_mIRegisterSubjectEventListener.OnSetSubject(Marshal.PtrToStringAnsi(subject));
		}
#if __IOS__
