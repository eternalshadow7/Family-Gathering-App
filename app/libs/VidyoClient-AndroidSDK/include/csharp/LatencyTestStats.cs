...
namespace VidyoClient
{
	public class LatencyTestStats{
		...
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr VidyoLatencyTestStatsGetUserDataNative(IntPtr obj);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		public static extern void VidyoLatencyTestStatsSetUserDataNative(IntPtr obj, IntPtr userData);
