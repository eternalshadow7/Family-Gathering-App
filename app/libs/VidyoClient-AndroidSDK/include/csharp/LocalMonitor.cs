...
namespace VidyoClient
{
	public class LocalMonitor{
		...
		private static extern LocalMonitorState VidyoLocalMonitorGetPreviewFrameDataUriNative(IntPtr m, ulong maxWidth, ulong maxHeight, [MarshalAs(UnmanagedType.LPStr)]String videoFrame);
		...
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoLocalMonitorSetDiscrerteConstraintsNative(IntPtr m, ulong maxFrameInterval, ulong minFrameInterval, uint width, uint height, double scaleFactor);
		...
		public Boolean SetDiscrerteConstraints(ulong maxFrameInterval, ulong minFrameInterval, uint width, uint height, double scaleFactor){
			...
			Boolean ret = VidyoLocalMonitorSetDiscrerteConstraintsNative(objPtr, maxFrameInterval, minFrameInterval, width, height, scaleFactor);
