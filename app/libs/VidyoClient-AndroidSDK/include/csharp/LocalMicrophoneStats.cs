...
namespace VidyoClient
{
	public class LocalMicrophoneStats{
		...
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr VidyoLocalMicrophoneStatsGetUserDataNative(IntPtr obj);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		public static extern void VidyoLocalMicrophoneStatsSetUserDataNative(IntPtr obj, IntPtr userData);
