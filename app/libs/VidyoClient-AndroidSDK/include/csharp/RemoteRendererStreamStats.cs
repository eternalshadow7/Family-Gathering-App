...
namespace VidyoClient
{
	public class RemoteRendererStreamStats{
		...
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr VidyoRemoteRendererStreamStatsGetUserDataNative(IntPtr obj);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		public static extern void VidyoRemoteRendererStreamStatsSetUserDataNative(IntPtr obj, IntPtr userData);
		...
		public RemoteRendererStreamStats(IntPtr obj){
			...
			codecName = Marshal.PtrToStringAnsi(VidyoRemoteRendererStreamStatsGetcodecNameNative(objPtr));
			...
			name = Marshal.PtrToStringAnsi(VidyoRemoteRendererStreamStatsGetnameNative(objPtr));
