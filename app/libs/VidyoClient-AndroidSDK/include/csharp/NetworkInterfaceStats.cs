...
namespace VidyoClient
{
	public class NetworkInterfaceStats{
		...
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr VidyoNetworkInterfaceStatsGetUserDataNative(IntPtr obj);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		public static extern void VidyoNetworkInterfaceStatsSetUserDataNative(IntPtr obj, IntPtr userData);
		...
		public NetworkInterfaceStats(IntPtr obj){
			...
			name = Marshal.PtrToStringAnsi(VidyoNetworkInterfaceStatsGetnameNative(objPtr));
			type = Marshal.PtrToStringAnsi(VidyoNetworkInterfaceStatsGettypeNative(objPtr));
		}
	};
}
