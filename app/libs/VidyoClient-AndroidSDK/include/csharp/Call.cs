...
namespace VidyoClient
{
	public class Call{
		...
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoCallSendMessageNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String message);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoCallSetSubjectNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String subject);
		...
		private static IInitiate _mIInitiate;
		...
		public Boolean SendMessage(String message){
			...
			Boolean ret = VidyoCallSendMessageNative(objPtr, message);

			return ret;
		}
		public Boolean SetSubject(String subject){

			Boolean ret = VidyoCallSetSubjectNative(objPtr, subject);
