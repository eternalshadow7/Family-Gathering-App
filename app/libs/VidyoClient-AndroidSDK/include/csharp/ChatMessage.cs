...
namespace VidyoClient
{
	public class ChatMessage{
		...
		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr VidyoChatMessageGetUserDataNative(IntPtr obj);

		[DllImport("libVidyoClient", CallingConvention = CallingConvention.Cdecl)]
		public static extern void VidyoChatMessageSetUserDataNative(IntPtr obj, IntPtr userData);
